...
module.exports = function (eleventyConfig) {
  ...
  markdownLibrary.renderer.rules.code_inline = (tokens, idx, options, env, slf) => {
    ...
    let language = "";
    if (i < 0) {
      return "<code" + slf.renderAttrs(token) + ">" + markdownIt.escapeHtml(str) + "</code>";
    }
    ...
    let highlighted = Prism.highlight(str, Prism.languages[language], language) || markdownIt.escapeHtml(str);
